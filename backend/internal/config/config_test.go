...
func TestLoadParsesProviderConfiguration(t *testing.T) {
	...
	if loaded.Emby.BaseURL != "https://emby.local" || loaded.EmbyPlaybackBaseURL != "http://qms-emby.local:8095" || loaded.Emby.APIKey == "" || loaded.Emby.Password != "emby-password-value" {
