...
val releaseVersionCode = providers.gradleProperty("MEDIA_HUB_VERSION_CODE").orElse("19028").get().toInt()
val releaseVersionName = providers.gradleProperty("MEDIA_HUB_VERSION_NAME").orElse("0.19.28").get()
