...
val releaseVersionCode = providers.gradleProperty("MEDIA_HUB_VERSION_CODE").orElse("20038").get().toInt()
val releaseVersionName = providers.gradleProperty("MEDIA_HUB_VERSION_NAME").orElse("0.20.38").get()
