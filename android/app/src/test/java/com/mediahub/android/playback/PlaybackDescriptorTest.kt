...
class PlaybackDescriptorTest {
    ...
    fun parsesSafeTemporaryDescription() {
        val value = parsePlaybackDescriptor(
            """{"streamUrl":"https://cdn.example/video.mkv?token=short","userAgent":"MediaHub Player","title":"Movie.mkv","sessionId":"${"a".repeat(48)}","startPositionMs":42000}""",
        )
        ...
        assertEquals("a".repeat(48), value.sessionId)
